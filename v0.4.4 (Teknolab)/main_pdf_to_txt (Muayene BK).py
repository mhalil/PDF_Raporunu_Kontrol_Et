...
##### "degerler.tsv" dosyasından DF olustur ve duzenle. ###############################
...
sartname_degerleri = { 
		...
		'Paslanmaz Celik_Çekme Gerilmesi (Rm)_min' : 700.0,						# Kilit Mekanizması, Anahtar ve Mafsal Pimi Numuneleri - A2 _ 70
		'Paslanmaz Celik_Çekme Gerilmesi (Rm)_max' : 1_000_000.0,				# Kilit Mekanizması, Anahtar ve Mafsal Pimi Numuneleri - A2 _ 70
		'Paslanmaz Celik_Rp0,2_min' : 450.0,									# Kilit Mekanizması, Anahtar ve Mafsal Pimi Numuneleri - A2 _ 70
		'Paslanmaz Celik_Rp0,2_max' : 1_000_000.0,								# Kilit Mekanizması, Anahtar ve Mafsal Pimi Numuneleri - A2 _ 70
		'Paslanmaz Celik_A5_min' : 40.0,										# Kilit Mekanizması - A5 Uzama Yüzdesi
		'Paslanmaz Celik_A5_max' : 1_000_000.0,									# Kilit Mekanizması - A5 Uzama Yüzdesi
		...
		'Paslanmaz Çelik Spektrometrik Analiz_S_min' : -1.0,					# Kilit Mekanizması, Anahtar ve Mafsal Pimi Numuneleri - A2 _ 70
		'Paslanmaz Çelik Spektrometrik Analiz_S_max' : 0.03,					# Kilit Mekanizması, Anahtar ve Mafsal Pimi Numuneleri - A2 _ 70
...
### Sonucu KAYDET
df_tsv.to_excel("Sonuc_ve_Mukayese.xlsx")
print("'Sonuc_ve_Mukayese.xlsx' dosyası olusturuldu.")
######################################################################
